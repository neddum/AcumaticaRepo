...
public class AcumaticaClass
{
 ...
 // Wait for the "Service Orders" element to be click-able
    ...
    executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("//div[@class='au-target main-icon-img main-Excel']")));
    

    WebElement ignoreButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/form/table[4]/tbody/tr[2]/td/table/tbody/tr[2]/td/button[2]")));
		ignoreButton.click();
		
//		Thread.sleep(900000);
		 CompletableFuture<Void> delayFuture = CompletableFuture.runAsync(() -> {
       try {
           TimeUnit.MINUTES.sleep(7); // Sleep for 15 minutes
   ...
   // Click on the Services element the second time
    WebElement servicesElement2 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div[data-id='f0cf4498-99c4-48f3-8dd8-bde9ed67f9d3']")));

    servicesElement2.click();
    
    Thread.sleep(2000);
    
    WebElement appointmentElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Appointments']")));
    ...
    WebElement ignoreButton2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/form/table[4]/tbody/tr[2]/td/table/tbody/tr[2]/td/button[2]")));
		ignoreButton2.click();
